...
import { Search, SortAsc, SortDesc, BookOpen, User, AlertTriangle } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Khám phá các tác giả thánh ca và tìm hiểu về tiểu sử của họ
        </p>
      </div>
      ...
      {/* Authors grid with error handling */}
        ...
        {isLoading ? (
          ...
          <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {debouncedQuery
                ? `Không có tác giả nào khớp với "${debouncedQuery}"`
